...
const Profile = () => {
  ...
  const editProfile = (newState) => async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BASE_API_URL}/edit-profile/${user.user_id}`,
        {
          method: "PUT",
          headers: {
      ...
      if (responseData) {
        ...
        currentUser.nom = formData.lastname;
        currentUser.pays = formData.country;
        currentUser.prenom = formData.firstname;
        currentUser.telephone = formData.phone;
        currentUser.avatar = formData.avatar;
        currentUser.motdepasse = formData.motdepasse;
        currentUser.role = formData.role;
        currentUser.user_id = formData.user_id;
  ...
  return (
    <Box
      sx={{ display: "flex", flexDirection: "column", padding: "1rem 2rem" }}
    >
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        >
          ...
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="#93B0C8" fontFamily="Montserrat">
              Profil
            </Typography>
          </Breadcrumbs>
        </Box>
                ...
                <Grid item xs={12} sm={12} md={12} lg={4}>
                  <Stack sx={{ boxShadow: "0px 5px 10px 1px #D5D5D5" }}>
                    ...
                    <Stack
                      ...
                      alignItems="center"
                      spacing={3}
                      sx={{ backgroundColor: "#FFF", padding: "1.35rem" }}
                    >
                      <Avatar
                        alt="user avatar"
                        src={profileImage}
                  ...
                  <Stack sx={{ boxShadow: "0px 5px 10px 1px #D5D5D5" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        Nous vous enverrons un message texte pour vérifier vos
                        tentatives de connexion sur des appareils et des
                        navigateurs non reconnus.
                      </Typography>
                      <Stack spacing={3}>
                        <Grid container>
                          <Grid item xs={12} sm={12} md={12} lg={12}>
