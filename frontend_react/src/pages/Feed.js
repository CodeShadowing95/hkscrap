      ...
      try {
        ...
        try {
          ...
          for (let index = 0; index < popular_sites.length; index++) {
            ...
            fetchFromServer("scrapes-count-by-site", { website, uid }).then(
              async (res) => {
              ...
              {user.role === "Modérateur" ? (
                <Box
                  sx={{
                    ...
                    alignItems: "center",
                    padding: "20px",
                    backgroundColor: theme === "light" ? "#FDFEFF" : "#1F2937",
                    borderRadius: "10px",
                    gap: 5,
                  }}
                >
                ...
                <Stack justifyContent="center" alignItems="center">
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      padding: "20px",
                      backgroundColor: "#fab7b9",
                      borderRadius: "50px",
                    }}
                  >
                    <TrendingUpIcon
                      sx={{ fontSize: "50px", color: "#d70f12" }}
                    />
                  </div>
                </Stack>
              </Box>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={12} md={12} lg={6}>
              <Stack
                sx={{
                  transition: "0.2s",
                  "&:hover": { boxShadow: "0px 5px 10px 1px #D5D5D5" },
                }}
              >
                {/* Title */}
                <Box
                  sx={{
                    ...
                    padding: "20px",
                    borderBottom:
                      theme === "light" ? "1px solid #e1e1e1" : "none",
                    backgroundColor: theme === "light" ? "#F8F8F9" : "#405472",
                  }}
                >
                  <Typography
                    sx={{
                  ...
                  >
                    Scrapings effectués par plateforme
                  </Typography>
                </Box>
                {/* Content */}
                <Box
                ...
                <Stack spacing={1}>
                  <Typography
                    ...
                    sx={{
                      fontSize: "1.3em",
                      fontWeight: 600,
                      color: theme === "light" ? "#152C5B" : "#FDFEFF",
                      fontFamily: "Montserrat",
                    }}
                  >
                    Sites phares
