    ...
    <Box sx={{ display: "flex", flexDirection: "column", padding: "1rem 2rem" }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5em", rowGap: "20px", width: "100%" }}>
        <Box sx={{ display: "flex", justifyContent: "flex-start", alignItems: "center", gap: 1 }}>
          ...
          <Typography variant="h1" sx={{ fontSize: "2.5em", fontWeight: "600", color: "#152C5B", fontFamily: "Montserrat" }}>{site.name}</Typography>
        </Box>
        {/* Breadcrumb */}
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Link underline="hover" color="inherit" href="/scrapers" fontFamily="Montserrat">
            Scrapers
          </Link>
          <Typography color="#93B0C8" fontFamily="Montserrat">{site.name}</Typography>
        </Breadcrumbs>
      </Box>
