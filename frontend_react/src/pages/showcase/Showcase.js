...
const Showcase = () => {
  ...
  return (
    ...
    <Stack sx={{ width: { xl: '100%' }, backgroundColor: "#eef0f6" }}>
      {/* ++++++++++++++++++++++++++++++++++++++++++ Navbar ++++++++++++++++++++++++++++++++++++++++++ */}
      <Box sx={{ display: "flex", top: 0, position: "sticky", justifyContent: "space-between", alignItems: "center", padding: "5px 20px", backgroundColor: "#f1f4f9", boxShadow: scrolling && "0 4px 6px rgba(0, 0, 0, 0.1)", transition: ".2s" }}>
        {/* Left side */}
